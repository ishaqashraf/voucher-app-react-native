...
class DealDetailsView extends Component {
    ...
    render() {
        ...
        if (dealDetail.length == 0) {
            return <Loader loading={loading} />;
        }
        return (
            <View style={styles.container}>
                <Header title={voucher.displayName} search back navigation={this.props.navigation} />
                <ScrollView style={styles.contentContainer}>
                    <View style={styles.sliderContainer}>
                        <Image source={{ uri: outlet.outletImageUrls[0] }} style={styles.sliderImage} />
                    </View>
